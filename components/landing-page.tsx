...
export default function LandingPage() {
  ...
  const cases = [
    {
      ...
      description:
        "Aumentamos las consultas en un 150% en 3 meses mediante campañas de Facebook Ads y Google Ads optimizadas.",
    ...
    },
    {
      ...
      description:
        "Implementamos un sistema de seguimiento automatizado que redujo las cancelaciones de citas en un 40%.",
    ...
    },
    {
      ...
      description:
        "Creamos una estrategia de contenido en redes sociales que aumentó el engagement en un 200% y las consultas en un 75%.",
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-b from-pink-50 to-white ${inter.className}`}
    >
      <Head>
        <title>
          IVEDI - Agencia de Marketing para Profesionales de la Salud
        </title>
        <meta
          name="description"
          content="Transforma tu práctica médica con soluciones de marketing digital inteligentes y automatizadas. Atrae y retén más pacientes con IVEDI."
        />
      </Head>
      {/* Navigation */}
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div className="mb-12 lg:mb-0 relative z-10">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-6xl mb-6 leading-tight">
                Revoluciona tu{" "}
                <span className="text-pink-600">Práctica Médica</span> con
                Marketing Inteligente
              </h1>
              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Transforma la manera en que atraes y retienes pacientes.
                Nuestras soluciones de marketing automatizadas e impulsadas por
                IA están diseñadas específicamente para profesionales de la
                salud.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  className="bg-white text-pink-600 hover:bg-pink-50 border-pink-600 text-base font-semibold px-6 py-3 rounded-full transition duration-300 ease-in-out"
                >
                  Ver Casos de Éxito
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nuestro enfoque sistemático garantiza resultados excepcionales
            ...
            {[
              {
                ...
                description:
                  "Evaluamos tu presencia digital actual y desarrollamos una estrategia personalizada para alcanzar tus objetivos específicos.",
              ...
              },
              {
                ...
                description:
                  "Ponemos en marcha campañas optimizadas, automatizamos procesos y creamos contenido atractivo para tu audiencia.",
              ...
              },
              {
                ...
                description:
                  "Seguimos de cerca el rendimiento de las campañas y realizamos ajustes continuos para maximizar los resultados.",
              ...
              },
              {
                ...
                description:
                  "Proporcionamos informes detallados y transparentes sobre el desempeño y las conversiones generadas.",
              ...
              },
              {
                ...
                title: "Escalamiento",
                description:
                  "Basándonos en los datos y el éxito obtenido, escalamos las estrategias más efectivas para un crecimiento continuo.",
              ...
              >
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 ${step.color} rounded-full p-2 z-10`}
                >
                  {step.icon}
                </div>
      ...
      <section className="py-24 bg-gradient-to-b from-pink-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Potencia tu presencia digital y atrae más pacientes con nuestros
              servicios especializados para profesionales de la salud.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Estrategias de publicidad digital optimizadas para atraer pacientes potenciales y aumentar la visibilidad de tu práctica médica.",
                color: "bg-blue-100 text-blue-600",
              },
              {
                ...
                description:
                  "Implementación de chatbots inteligentes para atención al cliente 24/7, programación de citas y respuesta a preguntas frecuentes.",
                color: "bg-green-100 text-green-600",
              },
              {
                ...
                description:
                  "Sistemas automatizados para mantener el contacto con pacientes, recordatorios de citas y seguimiento post-consulta por Email y WhatsApp.",
                color: "bg-yellow-100 text-yellow-600",
              },
              {
                ...
                description:
                  "Mejoramos el posicionamiento de tu sitio web en los motores de búsqueda para aumentar la visibilidad y atraer más pacientes potenciales.",
                color: "bg-purple-100 text-purple-600",
              },
              {
                ...
                description:
                  "Seguimiento detallado de leads y pacientes en un CRM personalizado para profesionales de la salud, integrado con ClickUp.",
              ...
              },
              {
                ...
                description:
                  "Desarrollo y gestión de contenido atractivo y educativo para aumentar el engagement y la confianza de los pacientes en tus redes sociales.",
                color: "bg-indigo-100 text-indigo-600",
              },
            ].map((service, index) => (
              <div
                key={index}
                className="bg-white rounded-xl border border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-2"
              >
                <div className="p-8">
                  <div
                    className={`${service.color} inline-block p-3 rounded-full mb-6`}
                  >
                    {service.icon}
                  </div>
                  ...
                  <a
                    href="#"
                    className="text-pink-600 font-semibold flex items-center hover:text-pink-700 transition-colors duration-300"
                  >
          ...
          <Accordion type="single" collapsible className="space-y-4">
            ...
            >
              ...
              <AccordionContent className="text-gray-600 px-4 py-2">
                Nuestro modelo se basa en comisiones por conversiones reales.
                Solo pagas cuando generamos resultados medibles para tu negocio,
                como nuevas consultas o pacientes. No hay costos iniciales ni
                tarifas mensuales fijas, lo que significa que nuestro éxito está
                directamente ligado al tuyo.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              ...
              <AccordionContent className="text-gray-600 px-4 py-2">
                Aunque cada caso es único, generalmente nuestros clientes
                comienzan a ver resultados en las primeras 2-4 semanas.
                Implementamos estrategias rápidas y efectivas, con una primera
                entrega en 2-3 días, lo que nos permite comenzar a generar
            ...
            >
              ...
              <AccordionContent className="text-gray-600 px-4 py-2">
                Tu satisfacción es nuestra prioridad. Si no estás completamente
                satisfecho, trabajaremos contigo para ajustar y mejorar nuestras
                estrategias sin costo adicional. Además, puedes cancelar el
                servicio en cualquier momento sin penalizaciones, ya que no hay
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Descubre cómo podemos ayudarte a crecer con nuestro modelo basado
              en resultados. Agenda una consulta gratuita y personalizada.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              ...
              <p className="text-sm">
                IVEDI es una agencia de marketing digital especializada en
                profesionales de la salud. Nuestro enfoque basado en resultados
                garantiza el crecimiento de tu práctica.
              </p>
            </div>
            <div>
